...
type OrderContextType = {
    ...
    isAdminShortcutsModalVisible: boolean,
    setIsAdminShortcutsModalVisible: React.Dispatch<React.SetStateAction<boolean>>,
...
export const OrderContextProvider = ({ children }: PropsWithChildren) => {
    ...
    const orderContextValue = {
        ...
        isAdminShortcutsModalVisible: adminProductsData.isAdminShortcutsModalVisible,
        setIsAdminShortcutsModalVisible: adminProductsData.setIsAdminShortcutsModalVisible,
